...
/**
 * Spotzee Email Proxy API - Customer Delivery Server Form
 *
 * Customer interface for configuring Spotzee Email Proxy API delivery servers.
 *
...
if ($viewCollection->itemAt('renderContent')) {
    ...
    if ($collection->itemAt('renderForm')) {
        ...
        foreach ($formFields as $fieldName => $fieldProps) {
            // Skip monthly_quota field when addon_id is set (managed by addon)
            if ($fieldName == 'monthly_quota' && !empty($server->addon_id)) {
                continue;
            }
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
	                    ...
	                    <?php echo t('servers', 'Please manually configure this webhook URL in your Spotzee account. Webhooks are no longer created automatically.'); ?><br />
                    </div>
                </div>
            </div>
        </div>
